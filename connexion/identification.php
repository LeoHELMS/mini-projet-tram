...
if(!isset($_SESSION['_login'])&& !isset($_SESSION['_pass']))
{
    ...
    <body>";
	echo '<p><b style="color:red">espace sécurisé</b><br/>Connectez-vous pour accéder à cette page</p>';
...
else
{
	if(($_admin_login==$_SESSION['_login'])&&($_SESSION['_pass']==$_admin_pass))
	{
	    ...
	    <body onload='Init()'>
	    bonjour,<br/>
	    administrateur ".$_SESSION['_login'].", vous nous avez manqués!
	    <br/><br/>
	...
	elseif(($_user_login==$_SESSION['_login'])&&($_SESSION['_pass']==$_user_pass))
	{
	    ...
	    <body onload='Init()'>
	    bonjour,<br/>
	    Utilisateur ".$_SESSION['_login'].", vous nous avez manqués!
	    <br/><br/>
	    ...
	    <td><input type='text' name='nom' value='".$_SESSION['_login']."' disabled='disabled'></td>
	    </tr>
	    <tr>
